    ...
    begin
        if i /= 0 then
            ...
            if condition = 1 then
                ...
                New_Line;
                Put ("- -R  <prefixe> avec <prefixe> le prefixe du fivhier d'entrée");
                New_Line;
            ...
            if condition = 1 then
                Put ("Fichier invalide l'un des sommets est supérieur ou égale au nombre de sommet il n'appartient donc pas au graohe!!");
            elsif condition = 2 then
                Put ("Mauvais format du fichier Le fichier doit ếtre du format: ");
                New_Line;
